namespace Oxpecker.Solid.Corvu
...
type [<Erase>] day =
    static member sunday : day = unbox 0
    static member monday : day = unbox 1
    static member tuesday : day = unbox 2
    static member wednesday : day = unbox 3
    static member thursday : day = unbox 4
    static member friday : day = unbox 5
    static member saturday : day = unbox 6
